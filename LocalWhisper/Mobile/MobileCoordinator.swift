...
private let logger = Logger(subsystem: "com.localwhisper.app", category: "MobileCoordinator")
...
final class MobileCoordinator: ObservableObject {
    ...
    func startLive() async {
        ...
        if !appState.permissionsService.microphoneGranted {
            ...
            if !granted {
                appState.errorMessage = "Microphone access is required. Enable it in Settings → LocalWhisper."
                return
            }
        }
