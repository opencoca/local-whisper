...
- [ ] **Large accessibility live-transcription window** #ux #accessibility
  ...
  - [x] `SettingsView` → Live Mode tab: master toggle, font-size slider (24–96 pt), high-contrast toggle, keep-above-other-apps toggle
  - [ ] `make build` clean
  - [ ] `make app` + relaunch
  - [ ] Manual: enable in Settings → Live Mode → start live mode → big window opens with current font; speak; confirmed text in semibold, tail lighter; on stop, window hides
